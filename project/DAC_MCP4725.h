...
//Device Addressing
//TIVA JA COLOCA ULTIMO BIT:
//(Fazendo deslocamento do endereço para a esquerda e inserindo o bit RW: uint8_t FirstByte = (ADDR << 1) | 0b(RW))
#define MCP4725_ADDR0       0x60 //|1|1|0|0|0|0|0|
#define MCP4725_ADDR1       0x61 //|1|1|0|0|0|0|1|
...
#define     DAC             0x0    //Write DAC Register: (C2 = 0, C1 = 1, C0 = 0, X = 0)
